...
export function noUiScripts () {
  return gulp.src('source/vendor/nouislider/nouislider.js')
    .pipe(terser())
...
function watchFiles () {
  ...
  gulp.watch('source/vendor/nouislider/nouislider.js', gulp.series(noUiScripts));
